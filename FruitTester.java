/*Write the Mango and the Jackfruit classes derived from 
Fruit class so that the following code generates the output below:
 */

public class FruitTester { // Driver code
